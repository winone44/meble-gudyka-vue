<template>
  <div id="admin-panel">
    ...
    <b-container class="mt-5">
      ...
      <b-row>
        <b-col cols="2">
          <b-button  class="btn-block" :to="{name:'home'}">Sprawdź</b-button>
        </b-col>
        <b-col cols="2">
          <b-button class="btn-block" variant="danger" @click="saveData">Zapisz</b-button>
        </b-col>
      </b-row>
    </b-container>
  </div>
...
export default {
  ...
  methods: {
    addNewGalleryItem() {
      ...
      this.$store.state.data.otherProjects.gallery.push(example)
    },
    addNewFolderItem() {
      const example = {
